#ifndef THREEWISE_XOR_BINARY_FUSE_FILTER_XOR_FILTER_PARTIALLYSORTED_H_
#define THREEWISE_XOR_BINARY_FUSE_FILTER_XOR_FILTER_PARTIALLYSORTED_H_
#include "xor_binary_fuse_filter.h"
namespace xorbinaryfusefilter_partiallysorted {
