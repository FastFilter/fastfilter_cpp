...
#ifndef FOURWISE_XOR_BINARY_FUSE_FILTER_XOR_FILTER_PREFETCH_H_
#define FOURWISE_XOR_BINARY_FUSE_FILTER_XOR_FILTER_PREFETCH_H_
#include "xor_binary_fuse_filter.h"
namespace xorbinaryfusefilter_4wise_prefetched {
...
XorBinaryFuseFilter<ItemType, FingerprintType, HashFamily>::Info() const {
  std::stringstream ss;
  ss << "4-wise XorBinaryFuseFilterPrefetch Status:\n"
     << "\t\tKeys stored: " << Size() << "\n";
  return ss.str();
}
} // namespace xorbinaryfusefilter_4wise_prefetched
